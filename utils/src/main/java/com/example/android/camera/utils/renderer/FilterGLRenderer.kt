...
class FilterGLRenderer : HandlerThread("GLRenderer") {
    ...
    fun render() {
        Log.i("FilterGLRender", "render " + GLRenderer.OES_TEXTURE_ID)
        Handler(looper).post {
            while (true) {
                ...
                bindGLProgram0(GLRenderer.OES_TEXTURE_ID)
...
//        var vMatrixHandler = GLES20.glGetUniformLocation(program0, "vMatrix")
        ...
        GLES20.glUniformMatrix4fv(coordMatrixHandler, 1, false, GLRenderer.COORD_MATRIX, 0)
    ...
    fun initProgram() {
        ...
        program0 = EGLUtil.createAndLinkProgram(
                ...
                R.raw.multi_screen_filter_fragtment_shader
        )
    }
